...
class AISubjectPage extends StatelessWidget {
  ...
  /// 构建顶部标题栏
  Widget _buildHeader(dynamic screenAdapter, AISubjectLogic logic) {
    return Container(
      padding: EdgeInsets.all(screenAdapter.getAdaptivePadding(16)),
      decoration: BoxDecoration(
  ...
  /// 构建Tab切换栏
  Widget _buildTabBar(dynamic screenAdapter, AISubjectLogic logic) {
    return Obx(() {
      return Container(
        padding: EdgeInsets.all(screenAdapter.getAdaptivePadding(4)),
        decoration: BoxDecoration(
          ...
          children: [
            Expanded(
              child: _buildTabItem(
                ...
                title: '岗位题目',
                type: 1,
                isSelected: logic.currentType.value == 1,
              ),
            ),
            SizedBox(width: screenAdapter.getAdaptiveWidth(4)),
            Expanded(
              child: _buildTabItem(
                ...
                title: '专业题目',
                type: 2,
                isSelected: logic.currentType.value == 2,
              ),
            ),
          ],
        ),
  ...
  Widget _buildTabItem({
    ...
    required AISubjectLogic logic,
    required String title,
    required int type,
    required bool isSelected,
  }) {
    return GestureDetector(
      onTap: () => logic.switchType(type),
      child: Container(
        padding: EdgeInsets.symmetric(
          vertical: screenAdapter.getAdaptivePadding(12),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: isExpanded ? Colors.grey[400] : Colors.purple,
                  foregroundColor: Colors.white,
                  padding: EdgeInsets.symmetric(
  ...
  /// 构建换一换按钮
  Widget _buildPagination(dynamic screenAdapter, AISubjectLogic logic) {
    return Container(
      padding: EdgeInsets.all(screenAdapter.getAdaptivePadding(16)),
      decoration: BoxDecoration(
